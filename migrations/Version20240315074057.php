...
final class Version20240315074057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client_bonus ADD CONSTRAINT FK_3CF5E3CD19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE client_bonus ADD CONSTRAINT FK_3CF5E3CD69545666 FOREIGN KEY (bonus_id) REFERENCES bonus (id)');
    }
